...
- Versões do prompt na coleta (atualização MODULAR, rastreável pelo carimbo `prompt_versao` de cada execução):
    ...
    - `cb7384f8b1fd`: 30 execuções, 2 casos.
...
- Período da coleta: 2026-07-16T10:31:22 a 2026-07-16T16:13:41.
...
- Fase 1 decisão (ação certa): 97% [95-98%] (672/695).
- Fase 2 formulação da query: 100% [99-100%] (327/327).
- Fase 3 retrieval: doc 93% [89-96%] | span 94% [90-96%] | MRR 0.70.
- Fase 4 answerability: 12/12 casos respondíveis têm o conteúdo na base.
- Fase 5 geração (juiz, SINAL): fidelidade 97% [92-99%] | relevância 100% [99-100%] | correção 96% [93-98%].
- Fase 6 comportamento (juiz, SINAL): 97% [94-98%] (310/320).
- Fase 7 citação: 100% [99-100%] (326/326).
...
### total-vagas-campus
- Classificação: retrieval abaixo de 100%; comportamento: 1 de 15 execuções (n baixo, IC largo: com esta amostra NÃO dá para separar ruído de bug sistemático de baixa frequência; tratar como bug a fechar até re-medir com n alto).
- Fase 3 retrieval: doc 8/15 (53% [30-75%]), o documento certo nem sempre entra no top-15.
- Fase 5a fidelidade: 13/15 (87% [62-96%]), afirmou algo sem apoio no contexto.
- Fase 5c correção: 8/15 (53% [30-75%]), fato central errado (consequência do retrieval).
...
- Exemplo do juiz: "Nao entregou o total consolidado de vagas de Canoas (afirmou nao existir), trazendo numeros do IFRS inteiro e de programas; fontes de Canoas (sem PDI) e ressalva ok, dados ancorados."
...
| total-vagas-campus | buscar | sim | 15/15 | 15/15 | 8/15 | - | 13/15 | 15/15 | 8/15 | 14/15 | 15/15 |
